...
?>
<script language="javascript">alert('Anda Berhasil Login');document.location="home.php"</script>
<?php
}else{
?>
<script language="javascript">alert('Anda Gagal Login, Silakan Cek User/Password Anda atau Silakan Daftar Terlebih Dahulu');document.location="index.php"</script>
<?php
}
}
?>
